...
\includeonly{chap1,chap2,appendix1,appendix2}

\title{\LaTeX~Template for 
\texorpdfstring{\\ Rackham Dissertations}{}}% If multiple lines are wanted
...
% If a bibliography of the entire dissertation is preferred
%\bibliographystyle{alpha}
%\bibliography{appen_bib/biblio.bib}
\end{document}
